                        ...
                        <div class="container position-relative megamenu-custom">
                            ...
                            <div class="collapse navbar-collapse">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('homeUser.index')}}">Trang chủ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('homeUser.orderUser')}}">Hóa đơn của bạn</a>
                                    </li>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 mengmenu_border">
                                                            ...
                                                            <ul>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',1)}}">sách giao tiếp</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',2)}}">sách thám hiểm</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',3)}}">sách tâm đắc</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',4)}}">sách nghĩ lớn</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',5)}}">sách thương  yêu</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',6)}}">sách con người và động vật</a></li>
                                                            </ul>
                                                            <h5 class="dropdown-title">  Cổ Điển </h5>
                                                            <ul>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',7)}}">sách tình cảm</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',8)}}">sách văn học</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',9)}}">sách về người nổi tiếng</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',10)}}">thế giới mới</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-lg-3 col-md-6 col-sm-12 mengmenu_border">
                                                            <h5 class="dropdown-title"> Tiểu Thuyết </h5>
                                                            <ul>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',11)}}">lãng mạn</a></li>
                                                                <li><i class="lni-angle-double-right right-arrow"></i><a class="dropdown-item" href="{{route('homeUser.booksListing',12)}}">tưởng tượng</a></li>
                                                            </ul>
                                                        </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('homeUser.informattionUser')}}">chào {{$user->name}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('homeUser.supportsCustomer')}}">liên lạc</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="inner-wrapper">
                            ...
                            <nav class="side-nav w-100">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('homeUser.informattionUser')}}"> trang cá nhân của bạn</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div id="sideNavPages1" class="collapse sideNavPages">
                                            <ul class="navbar-nav mt-2">
                                                <li class="nav-item"><a class="nav-link" href="{{route('homeUser.booksListing',1)}}">Sách Cuộc Sống</a></li>
                                                <li class="nav-item"><a class="nav-link" href="{{route('homeUser.booksListing',7)}}"> Sách Cổ Điển</a></li>
                                                <li class="nav-item"><a class="nav-link" href="{{route('homeUser.booksListing',11)}}">Sách Tiểu Thuyết</a></li>
                                            </ul>
                                    <li class="nav-item">
                                ...
                                <li class="nav-item">
                                        <a class="nav-link" href="{{route('homeUser.logout')}}">Đăng xuất</a>
                                    </li>
                                </ul>
                            </nav>
                    ...
                    <div class="manage-icons d-inline-block">
                        <ul class="d-flex justify-content-center align-items-center">
                            ...
                            <li class="d-inline-block mini-menu-card">
                                <a class="nav-link" id="add_cart_box" href="{{route('homeUser.cart')}}">
        ...
        <div class="row">
            <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center text-center text-lg-left">
                <div class="banner-description">
                    ...
                    <a href="{{route('homeUser.index')}}" class="btn animated">MUA SẮM NGAY  <i class="fas fa-shopping-cart"></i></a>
                </div>
            </div>
        </div>
    </div>
